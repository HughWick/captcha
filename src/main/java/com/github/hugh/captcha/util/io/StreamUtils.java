package com.github.hugh.captcha.util.io;

import com.github.hugh.captcha.constant.CharsetCode;
...
public class StreamUtils {
    ...
    public static InputStream getInputStream(final String filePath) {
        ...
        try {
            ...
            try {
                ...
                if (inputStream == null) {
                    throw new CaptchaException("Could not find file: " + filePath);
                }
            }
        } catch (IOException localIOException1) {
            throw new CaptchaException(localIOException1);
        }
        return inputStream;
    }
    ...
    public static byte[] resourceToByteArray(String path) {
        try (InputStream inputStream = getInputStream(path)) {
            ...
            throw new CaptchaException(ioe);
        }
    }
}
