package com.github.hugh.captcha.cache;
...
public class GuavaCache {
     ...
     * 图片验证接收参数缓存
     */
    private static CacheLoader<String, ImageVerificationVo> VERIFY_CACHE_LOADER = CacheLoader
            .from(key -> null);

    /**
     * Guava 缓存策略
     */
    public static LoadingCache<String, ImageVerificationVo> VERIFY_CACHE = create(300, VERIFY_CACHE_LOADER);
